...
public class ConnectionManager {
    ...
    public ConnectionManager(McBitCoin mcBitCoin) {
        this.mcBitCoin = mcBitCoin;
        try {
            connection = createConnection(mcBitCoin.getConfigSettings().getHost(), mcBitCoin.getConfigSettings().getPort()
                    , mcBitCoin.getConfigSettings().getDatabase(), mcBitCoin.getConfigSettings().getUsername(), mcBitCoin.getConfigSettings().getPassword());
        ...
        try {
            ...
            if (tables.next()) {
                mcBitCoin.getLogger().log(Level.INFO, "Table already created");
            } else {
